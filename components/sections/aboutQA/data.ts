...
export const aboutQAData = [
    {
        title: "Vad bygger vi?",
        text: `Lewa Bostad utvecklar radhus och parhus med bostadsrättsform i Stockholms förorter.
    ...
    {
        title: "Hur bygger vi?",
        text: `För oss är kvalitet aldrig ett tillval. Den sitter i helheten – i ritningen, hantverket och känslan
            när du kliver in. Vi arbetar med noggrant utvalda leverantörer och material som håller över
            tid. Det handlar inte om lyx, utan om omtanke och noggrannhet i varje steg.
